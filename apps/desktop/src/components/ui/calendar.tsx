  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        button_previous: "absolute left-1 top-0 inline-flex items-center justify-center h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 border border-input rounded-md",
        button_next: "absolute right-1 top-0 inline-flex items-center justify-center h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 border border-input rounded-md",
