...
export async function cleanDatabase(prisma: PrismaService): Promise<void> {
  ...
  await prisma.$executeRawUnsafe(
    `TRUNCATE TABLE "CalendarIntegration", "File", "Activity", "Notification", "ThreadLink", "Todo", "TeamMember", "Team", "WorkspaceMember", "WorkspaceInvite", "Workspace", "RefreshToken", "User" CASCADE`,
  );
}
