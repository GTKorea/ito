...
async function main() {
    ...
    await prisma.$executeRawUnsafe(`TRUNCATE TABLE "CalendarIntegration", "File", "Activity", "Notification", "ThreadLink", "Task", "TeamMember", "Team", "SlackUser", "SlackWorkspace", "WorkspaceMember", "WorkspaceInvite", "Workspace", "RefreshToken", "User" CASCADE`);
    ...
    for (let i = 0; i < 15; i++) {
        ...
        calendarTasks.push(prisma.task.create({
            data: {
                title: titles[i],
